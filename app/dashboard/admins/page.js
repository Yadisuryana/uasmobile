...
const tabs = [
  ...
  { id: 'magangmhs', label: 'Magang Mahasiswa', icon: <FileClock size={14} /> },
  { id: 'jadwal', label: 'Jadwal Magang', icon: <FileText size={14} /> },
  { id: 'assign', label: 'Assign Dosen Pembimbing', icon: <ClipboardList size={14} /> },
  { id: 'laprak', label: 'Validasi Laporan Akhir', icon: <FileClock size={14} /> },
  { id: 'monitor', label: 'Monitor Progres Mahasiswa', icon: <FileText size={14} /> },
    ...
    if (typeof window !== 'undefined') {
      ...
      if (userStr) {
        try {
          ...
          setUserName(userObj.nama || 'Admin')
